...
export default function CabinetMedicalToulouse() {
  const [isMenuOpen, setIsMenuOpen] = useState(false);

  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
      
      {/* Top Bar - Very common in French medical sites for quick info */}
      <div className="bg-blue-900 text-white text-sm py-2 px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <p className="flex items-center gap-2 mb-2 md:mb-0">
          ...
          <div className="flex gap-4 text-blue-200 text-xs md:text-sm">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          {/* CTA Button - Doctolib Style */}
          <button className="hidden md:flex bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-full font-medium transition shadow-lg shadow-blue-200 items-center gap-2">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t p-4 flex flex-col gap-4 shadow-lg">
            <a href="#" className="py-2 border-b">Accueil</a>
            <a href="#" className="py-2 border-b">L'Équipe</a>
            <a href="#" className="py-2 border-b">Spécialités</a>
            <button className="bg-blue-600 text-white py-3 rounded-lg flex justify-center items-center gap-2 font-medium">
              <Calendar className="h-4 w-4" />
              Prendre rendez-vous
            </button>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3.5 rounded-lg font-medium transition flex items-center justify-center gap-2 shadow-xl shadow-blue-100">
          ...
          <div className="absolute top-40 right-40 w-full max-w-xl bg-white p-2 rounded-2xl shadow-2xl transform rotate-1 hover:rotate-0 transition duration-500">
                  <div className="relative h-70 w-full bg-slate-100 rounded-xl overflow-hidden">
                    <Image 
                      src="/doctora.png" 
                  ...
                  <div className="p-6">
                     <h3 className="text-xl font-bold text-slate-800 mb-2">Dr. Sophie MARTIN</h3>
                     <p className="text-teal-600 font-medium mb-4">Directrice Médicale</p>
      ...
      {/* Services Grid */}
      <section className="py-20 bg-slate-50" id="specialites">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <h3 className="text-blue-900 font-bold text-sm uppercase tracking-wider mb-2">NOS COMPÉTENCES</h3>
            <h2 className="text-3xl font-bold text-slate-900">Un parcours de soins complet</h2>
          </div>
      ...
      <section className="bg-white py-20 border-t border-slate-100" id="infos">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            
            {/* Map Placeholder */}
            <div className="bg-slate-200 rounded-2xl h-[400px] w-full relative overflow-hidden shadow-lg">
               <iframe 
        ...
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-3 gap-8 mb-8 border-b border-slate-800 pb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://www.ameli.fr/" target="_blank" className="hover:text-white">Ameli.fr</a></li>
            </ul>
          </div>
          <div>
